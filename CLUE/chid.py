...
# 加载数据集
train_data = load_data(data_path + 'chid/train.json', data_path + 'chid/train_answer.json')
valid_data = load_data(data_path + 'chid/dev.json', data_path + 'chid/dev_answer.json')
