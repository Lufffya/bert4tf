...
# 加载数据集
train_data = load_data_train(data_path + r'MNLI/train.tsv')
valid_data = load_data_val(data_path + r'MNLI/dev_matched.tsv')
valid_data_mis = load_data_val(data_path + r'MNLI/dev_mismatched.tsv')
