...
# 加载数据集
train_data = load_data(data_path + r'MRPC/msr_paraphrase_train.txt')
valid_data = load_data(data_path + r'MRPC/msr_paraphrase_test.txt')
...
class Evaluator(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        print(u'val_acc: %.5f, best_val_acc: %.5f, F1: %.5f\n' % (val_acc, self.best_val_acc, f1))
